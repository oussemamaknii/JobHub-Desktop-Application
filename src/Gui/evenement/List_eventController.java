...
public class List_eventController implements Initializable {
    ...
    private void allEvents(){
        try {
            ...
            for (int i = 0; i < lp.size(); i++) {
                ...
                Image im = new Image("file:///C:\\Users\\Ryaan\\Desktop\\projet\\JobHub-Desktop-Application\\images\\" + lp.get(i).getImage());
                ...
                Image img = new Image("file:///C:\\Users\\Ryaan\\Desktop\\projet\\JobHub-Desktop-Application\\images\\crossIcon.png");
    ...
    private void filteredEvents(List<event> lp){
            ...
            for (int i = 0; i < lp.size(); i++) {
                ...
                event selectedEvent=lp.get(i);
                System.out.println(lp.get(i).getImage());
                Image image = new Image("file:///C:\\Users\\Ryaan\\Desktop\\projet\\JobHub-Desktop-Application\\images\\" + lp.get(i).getImage());
